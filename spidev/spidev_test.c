...
uint8_t default_tx[] = {
	0xA8,0x03,0x00,0x00,0x00,0xFF,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
static void get_msg_a8_firmware_version(int fd) {
	goodix_fp_out_packet packet = {
		.fields = {
			.type = GOODIX_FP_PACKET_TYPE_FIRMWARE_VERSION,
			.payload_size = 2 + 1,
			.payload = { 0 }
		}
	};
	...
	packet.fields.payload[2] = calc_checksum(GOODIX_FP_PACKET_TYPE_FIRMWARE_VERSION, packet.fields.payload, 2);
